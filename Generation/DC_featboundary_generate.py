...
def load_models(args, device):
    ...
    print("loaded feature-boundary checkpoint:", args.diffusion_prior_ckpt)
...
def extract_condition_cache(args, device, run_dir, conditioner):
    ...
    cache_path = run_dir / f"featboundary_condition_cache_{args.subject}.pt"
    ...
    stats_path = run_dir / f"featboundary_boundaries_{args.subject}.csv"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate images with Feature-Change Boundary 4-Chunk + Router prior.")
